...
augroup PluginNotes
  ...
  for s:directory in xolox#notes#find_directories(0)
    " Modified by Kevin 10/31/14 to prevent No matching autocommand errors
    "exe 'au BufWriteCmd' xolox#notes#autocmd_pattern(s:directory, 1) 'call xolox#notes#save()'
    exe 'au BufWriteCmd' xolox#notes#autocmd_pattern(s:directory, 1) 'silent! call xolox#notes#save()'
  endfor
  unlet s:directory
augroup END
